//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="LOGIC_ELEMENTS" LPM_PIPELINE=2 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=8 LPM_WIDTHB=8 LPM_WIDTHP=16 MAXIMIZE_SPEED=5 clock dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
`endif
	...
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Error: The Logical Element multiplier implementation cannot be used together with synchronous clear signal for LPM_MULT.");
	end
endmodule //mult_o3q
//ERROR FILE
