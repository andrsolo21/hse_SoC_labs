...
//VERSION_BEGIN 17.1 cbx_altfp_inv 2017:10:25:18:06:52:SJ cbx_cycloneii 2017:10:25:18:06:53:SJ cbx_lpm_add_sub 2017:10:25:18:06:53:SJ cbx_lpm_compare 2017:10:25:18:06:53:SJ cbx_lpm_mult 2017:10:25:18:06:53:SJ cbx_lpm_mux 2017:10:25:18:06:53:SJ cbx_mgl 2017:10:25:18:08:29:SJ cbx_nadder 2017:10:25:18:06:53:SJ cbx_padd 2017:10:25:18:06:53:SJ cbx_stratix 2017:10:25:18:06:53:SJ cbx_stratixii 2017:10:25:18:06:53:SJ cbx_util_mgl 2017:10:25:18:06:53:SJ  VERSION_END
...
module  invert_altfp_inv_and_or_ckd
	( 
	aclr,
	clken,
	clock,
...
endmodule //invert_altfp_inv_and_or_ckd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  invert_altfp_inv_and_or_umd
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	assign
		...
		operation_r2_w = {(operation_r2_w[2] & connection_r1_w[3]), (operation_r2_w[1] & connection_r1_w[2]), (operation_r2_w[0] & connection_r1_w[1]), connection_r1_w[0]},
		result = connection_dffe2;
endmodule //invert_altfp_inv_and_or_umd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  invert_altfp_inv_and_or_vid
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	assign
		...
		result = connection_dffe2;
endmodule //invert_altfp_inv_and_or_vid
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  invert_altfp_inv_and_or_hld
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	assign
		...
		operation_r2_w = {(operation_r2_w[0] & connection_r1_w[1]), connection_r1_w[0]},
		result = connection_dffe2;
endmodule //invert_altfp_inv_and_or_hld
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  invert_altfp_inv_csa_tbi
	( 
	aclr,
	clken,
	clock,
...
endmodule //invert_altfp_inv_csa_tbi
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  invert_altfp_inv_csa_47i
	( 
	aclr,
	clken,
	clock,
...
endmodule //invert_altfp_inv_csa_47i
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  invert_altfp_inv_csa_58i
	( 
	aclr,
	clken,
	clock,
...
module  invert_altfp_inv_vec
	...
	invert_altfp_inv_and_or_ckd   altfp_inv_and_or2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	invert_altfp_inv_and_or_umd   altfp_inv_and_or3
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	invert_altfp_inv_and_or_vid   altfp_inv_and_or4
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	invert_altfp_inv_and_or_hld   altfp_inv_and_or5
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	invert_altfp_inv_csa_tbi   diff_adder_0
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	invert_altfp_inv_csa_tbi   diff_adder_1
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	invert_altfp_inv_csa_47i   slope_r1c1_add
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	invert_altfp_inv_csa_47i   slope_r1c2_add
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	invert_altfp_inv_csa_47i   slope_r1c3_add
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	invert_altfp_inv_csa_47i   slope_r2c1_add
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	invert_altfp_inv_csa_58i   slope_r2c2_add
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	invert_altfp_inv_csa_58i   slope_r3c1_add
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
...
endmodule //invert_altfp_inv_vec
//VALID FILE
...
module invert (
	...
	invert_altfp_inv_vec	invert_altfp_inv_vec_component (
				.clock (clock),
				.data (data),
				.result (sub_wire0));
